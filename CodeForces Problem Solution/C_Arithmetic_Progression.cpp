...
void solve(){
  ...
  if(n == 1) cout << -1;
    ...
    ll x = v[1]-v[0];
    if((v[1]-v[0]) %2 == 0) cout << 3 << nl << v[0]-x << " "<< v[0]+(v[1]- v[0]) / 2 << " ";
    else cout << 2 << nl << v[0]-x << " ";
    cout << v[1]+x;
  }
  else{
    ll x = v[1]-v[0];
    ...
    else if(cnt == 1 && (v[ind+1]-v[ind])%2 == 0 && (v[ind+1]-v[ind])/2 == x){
      cout << 1 << nl << v[ind]+x;
    }
    else if(cnt == n-2 && (v[1]-v[0])%2 == 0 && (v[1]-v[0])/2 == v[2]-v[1]){
      cout << 1 << nl << v[0]+(v[2]-v[1]);
    }
    else cout << 0;
  }
}
